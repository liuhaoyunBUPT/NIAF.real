...
if __name__ == '__main__':
    ...
    args.add_argument('-i', '--in_root', type=str, default='/home/lhy/Code/ICRA/beast_calvin/dataset',
                      help='This path contains task_XXX_D/ directories.')
    args.add_argument('--in_task', type=str, default='task_ABCD_D',
    ...
    args.add_argument('-f', '--force', default=True,
